            ...
            <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 flex justify-center">
                <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                    ...
                    {ServiceCardData.map((serviceCard, index) => (
                        <div key={index} className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow drop-shadow-lg flex flex-col">
                            <div className="relative">
                                <BsCarFrontFill className="absolute top-0 right-0 w-52 h-52 opacity-10 text-green" />
                            </div>
                            <div>
